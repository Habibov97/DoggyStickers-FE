  ...
  return (
    <div className="w-64 h-full border border-gray-200 shadow-md">
      <div className="w-full overflow-hidden border-b border-gray-200">
        <img src={Unicorn} alt="unicorn" className="w-full h-auto transition-all duration-300 hover:scale-110" />
      </div>
      <div className="my-3 ml-3">
        <p className="text-2xl text-blue-800 font-bold font-josefin mb-4">The Unicorn</p>
        <p className="text-md text-stone-500 font-semibold font-josefin mb-">They exists!</p>
